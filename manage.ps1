# LuaBase Docker Helper Script
# Convenience commands for managing the Lua development container
...
function Show-Help {
    ...
    Write-Host "  Lua Docker Environment Manager" -ForegroundColor Cyan
    Write-Host "======================================" -ForegroundColor Cyan
    Write-Host ""
...
function Start-Container {
    Write-Host "Starting Lua development container..." -ForegroundColor Green
    docker-compose up -d
    Write-Host "Container started! Use '.\manage.ps1 shell' to enter." -ForegroundColor Cyan
}

function Stop-Container {
    Write-Host "Stopping Lua development container..." -ForegroundColor Yellow
    docker-compose down
    Write-Host "Container stopped." -ForegroundColor Cyan
}

function Restart-Container {
    Write-Host "Restarting Lua development container..." -ForegroundColor Yellow
    docker-compose restart
    Write-Host "Container restarted." -ForegroundColor Cyan
}

function Build-Container {
    Write-Host "Building Lua development container..." -ForegroundColor Green
...
function Show-Status {
    ...
    docker images | Select-String "lua-dev"
    Write-Host ""
    Write-Host "Docker Volumes:" -ForegroundColor Cyan
    docker volume ls | Select-String "lua-dev"
}
